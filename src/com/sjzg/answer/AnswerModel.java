...
public class AnswerModel {
	...
	public String toString() {
		return "AnswerModel [ID=" + ID + ", UserID=" + UserID + ", QuestionID="
				+ QuestionID + ", TestID=" + TestID + ", TimeUsed=" + TimeUsed
				+ ", Track=" + Track + ", Grade=" + Grade + ", Unfocus="
				+ Unfocus + ", Appear=" + Appear + ", UserAnswer=" + UserAnswer
				+ ", LookBackTime=" + LookBackTime + ", collection="
				+ collection + "]";
	}
